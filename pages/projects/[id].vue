<template>
  <div class="pt-28 pb-20 bg-gray-50 dark:bg-dark-800 min-h-screen">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div
        :class="[
          'w-full aspect-video rounded-2xl mb-10 relative overflow-hidden',
          project.gradient,
        ]"
      >
        <img
      ...
      <section>
        ...
        >
          <a
            ...
            class="flex-1 flex items-center justify-center gap-2.5 px-8 py-4 bg-primary-600 hover:bg-primary-700 active:bg-primary-800 text-white font-semibold rounded-xl transition-colors text-base"
          >
            <svg
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            class="flex-1 flex items-center justify-center gap-2.5 px-8 py-4 border-2 border-gray-200 dark:border-dark-600 bg-white dark:bg-dark-900 text-gray-800 dark:text-gray-200 font-semibold rounded-xl hover:border-primary-400 dark:hover:border-primary-600 hover:bg-gray-50 dark:hover:bg-dark-800 transition-colors text-base"
          >
            <svg
              class="w-5 h-5 shrink-0"
              fill="currentColor"
