<template>
  <div class="relative min-h-screen flex items-center justify-center overflow-hidden">
    <!-- Background Pattern -->
    <div class="absolute inset-0 bg-gradient-to-br from-primary-50 via-white to-blue-50 dark:from-dark-900 dark:via-dark-800 dark:to-blue-900/20"></div>
      ...
      <div class="text-center">
        ...
        <div class="mb-8 animate-fade-in">
          <div class="relative inline-block">
            ...
            />
            <div class="absolute inset-0 rounded-full bg-gradient-to-r from-primary-500 to-blue-500 opacity-20 animate-pulse"></div>
          </div>
        </div>
        ...
        <!-- CTA Buttons -->
        <div class="animate-slide-up flex flex-col sm:flex-row gap-4 justify-center" style="animation-delay: 0.8s">
          <router-link
            to="/projects"
        ...
        <div class="animate-fade-in mt-16" style="animation-delay: 1s">
          ...
          <p class="text-sm text-gray-400 dark:text-gray-600 mt-2">Desliza hacia abajo</p>
        </div>
      </div>
    </div>
  </div>
